...
RSpec.describe FruitsController, type: :controller do
  describe 'GET to index' do
    ...
    describe 'as HTML' do
      before do
        get :index # RSpec version of HTTParty.get
      end
      ...
      it 'should gives us the fruits in an instance variable in reverse order' do
        expect(assigns(:fruits)).to be # Hamlet (assigns(fruits) == @fruits)
  ...
  describe 'POST to create' do
    describe 'a fruit with valid information' do
      ...
      it 'should redirect to the show page' do
        expect(response).to redirect_to(fruits_path(assigns(:fruit))) # /fruits/:id
      end

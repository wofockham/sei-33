...
users["Joel"] = {:twitter => 'edwardawkward', :favorite_numbers => [666, 777, 999, 12]}
...
# Fancy version:
# users.map { |username, info| info[:favorite_numbers] }.inject(&:&)
# 1. How would you return an array containing all users' favorite numbers, sorted, and excluding duplicates?
users.map { |username, info| info[:favorite_numbers] }.flatten.sort.uniq
